      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md shadow-sm py-2
        ...
        <div>
          ...
          <textarea
            ...
            className="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md shadow-sm
						 py-2 px-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 
        ...
        <div className="mt-1 flex items-center">
          ...
          <label
            htmlFor="image"
            className="cursor-pointer bg-gray-100 py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
