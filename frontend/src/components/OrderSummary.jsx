  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <motion.button
          className="flex w-full items-center justify-center rounded-lg bg-green-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-gray-300"
